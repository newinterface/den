...
const ClusteredMapView = ({
  ...
  const btnCurrentColor = theme?.key !== 'dark' ? '#ffffff' : '#000000';

  const btnIconCurrentColor = theme?.key === 'dark' ? '#ffffff' : '#000000';
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        style={[
          ...
          {backgroundColor: btnCurrentColor},
        ]}>
        <Icon size={20} name={'my-location'} color={btnIconCurrentColor} />
      </TouchableOpacity>
