...
import {PRODUCT_RADIUS_RANGE} from 'src/config/constant';
...
class ProductsScreen extends React.Component {
  ...
  getData = page => {
    ...
    const query = Map({
      ...
      per_page: 4,
      page: page,
      radius_lat: location.latitude,
      radius_lng: location.longitude,
      radius_range: PRODUCT_RADIUS_RANGE,
    })
  ...
  render() {
    const {productView, defaultCurrency, currency, days, navigation, t} =
      this.props;
        ...
        {loading || (!loading && data.length) ? (
          <View style={styles.viewList}>
            <Container style={styles.viewRefineSwitch}>
              <Refine onPress={this.clickRefine} />
              <SwitchProduct productView={productView} loading={loading} />
            </Container>
